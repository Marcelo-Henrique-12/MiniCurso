            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 d-flex justify-content-start align-items-center">
                        <img id="foto-preview" src="{{$produto->foto_url}}" alt="Prévia do Foto" class="img-thumbnail"
                ...
                <div class="row">
                    <div class="col-xl-4 form-group">
                        ...
                        <input type="text" class="form-control @error('valor') is-invalid @enderror" id="valor"
                            name="valor" placeholder="Valor do produto" value="{{ old('valor', number_format($produto->valor, 2, ',', '.')) }}">
                        @error('valor')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="card-footer">
                    <a href="{{ route('produtos.index') }}" type="button" class="btn btn-secondary">Voltar</a>
